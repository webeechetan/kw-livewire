<div class="container">
    ...
    <div class="dashboard-head">
        <div class="row align-items-center">
            <div class="col d-flex align-items-center gap-3">
                ...
                <!-- <a wire:navigate href="<?php echo e(route('team.add')); ?>" href="javascript:void(0);" class="btn-border btn-border-sm btn-border-primary"><i class="bx bx-plus"></i> Add Team</a> -->
            </div>
    ...
    <div class="row mt-4">
            ...
            <div class="col-md-4 mt-2">
                <div class="card_style card_style-team">
                        ...
                        <div class="cus_dropdown-body cus_dropdown-body-widh_s">
                            <div class="cus_dropdown-body-wrap">
                                <ul class="cus_dropdown-list">
                                    <li><a wire:navigate href="<?php echo e(route('team.edit' , $team->id )); ?>"><span class="text-secondary"><i class='bx bx-pencil' ></i></span> Edit</a></li>
                    ...
                    <div class="card_style-list_head">
                        <div class="card_style-team-profile-img"><span><img src="<?php echo e(env('APP_URL')); ?>/storage/<?php echo e($team->image); ?>" alt="<?php echo e($team->name); ?>"></span></div>
                        <div class="card_style-team-profile-content">
                            <h4 class="mb-1"><a wire:navigate href="<?php echo e(route('team.profile')); ?>"><?php echo e($team->name); ?></a></h4>
                            <div class="mb-1">
        ...
        <div class="pagintaions mt-4">
            <?php echo e($teams->links(data: ['scrollTo' => false])); ?>
...
<?php /**PATH C:\xampp\htdocs\kw-livewire\.vapor\build\app\resources\views\livewire\teams\list-team.blade.php ENDPATH**/ ?>