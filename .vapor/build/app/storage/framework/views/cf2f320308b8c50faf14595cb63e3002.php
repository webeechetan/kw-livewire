    ...
    <script>
        $(document).ready(function() {
            ...
            $('.users').on('change', function (e) {
                ...
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('project_users', data);
            });
...
<?php /**PATH C:\xampp\htdocs\kw-livewire\.vapor\build\app\resources\views\livewire\components\add-project.blade.php ENDPATH**/ ?>