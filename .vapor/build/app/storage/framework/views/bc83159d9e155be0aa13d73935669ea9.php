    ...
    <div class="header-signup d-flex align-items-center">
        <div class="container">
            <div class="row justify-content-md-center">
                <div class="col-sm-6">
                    <div class="logo">
                        <img src="<?php echo e(asset('')); ?>assets/images/logo.png" alt="Kaykewalk Logo" />
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col text-center mx-auto">
                    <img class="signup-welcome-img" src="<?php echo e(asset('')); ?>assets/images/signup_welcome.png" alt="Sign Up Welcome" />
...
<?php /**PATH C:\xampp\htdocs\kw-livewire\.vapor\build\app\resources\views\livewire\register.blade.php ENDPATH**/ ?>