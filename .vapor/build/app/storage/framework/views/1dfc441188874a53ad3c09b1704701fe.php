                        ...
                        <div class="attached_files">
                            <div class="attached_files-item">
                                <div class="attached_files-item-preview">
                                    <img class="attached_files-item-thumb" src="<?php echo e(env('APP_URL')); ?>/storage/images/invite_banner.jpg" alt="" />
                                </div>
                            </div>
                            <div class="attached_files-item">
                                <div class="attached_files-item-preview">
                                    <img class="attached_files-item-thumb" src="<?php echo e(env('APP_URL')); ?>/storage/images/thankyou.jpg" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="cmnt_item_row">
                                <div class="cmnt_item_user">
                                    <div class="cmnt_item_user_img">
                                        <img class="rounded-circle" src="<?php echo e(env('APP_URL')); ?>/storage/images/users/Chetan%20Singh.png">
                                    </div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
            ...
            $(".task-users").on('change', function (e) {
                ...
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('task_users', data);
            });
            ...
            $(".task-notify-users").on('change', function (e) {
                ...
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('task_notifiers', data);
            });
            ...
            flatpickr(".task-due-date", {
                ...
                onChange: function(selectedDates, dateStr, instance) {
                    ...
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('due_date', dateStr);
                }
            });
            ...
            document.addEventListener('edit-task', event => {
                ...
                //             <a href="<?php echo e(env('APP_URL')); ?>/storage/${attachment.attachment_path}" target="_blank">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\kw-livewire\.vapor\build\app\resources\views\livewire\components\add-task.blade.php ENDPATH**/ ?>