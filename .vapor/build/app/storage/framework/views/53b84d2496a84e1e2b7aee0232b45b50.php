                                    ...
                                    <tr>
                                        <td>
                                            <table class="emailer-text-wrap mxauto" width="100%" cellcellspacing="0" cellpadding="">
                                                <tr>
                                                    <td>
                                                        <h2 style="margin-top: 0; margin-bottom: 30px;">Hi there <?php echo e($user->name); ?>!</h2>
                                                        <?php if($comment): ?>
                                                            <p><?php echo e($comment->user->name); ?> has commented on a task.</p>
                                                            <p>Task: <?php echo e($task->name); ?></p>
                                                            <p>Comment: <?php echo $comment->comment; ?></p>
                                                        <?php else: ?>
                                                            <p><?php echo e($task->assignedBy->name); ?> has mentioned you in a task.</p>
                                                            <p>Task: <?php echo e($task->name); ?></p>
                                                        <?php endif; ?>
                                                        <p>
                                                            Thanks,<br>
...
</html><?php /**PATH C:\xampp\htdocs\kw-livewire\.vapor\build\app\resources\views\mails\mention-user-mail.blade.php ENDPATH**/ ?>