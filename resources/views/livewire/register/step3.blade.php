        ...
        <div class="container">
            ...
            <div class="row ">
                <div class="col-xl-7 col-xxl-6 mx-auto text-center">
                    <div id="onboarding" >
                        <span class="d-block text-light" id="step-counter">Step 4/3</span>
                        <div class="row mt-2 mb-4">
                            <div class="col-xxl-5 col-lg-6 mx-auto"><div id="progress-container"><div id="progress-bar" style="width:75%"></div></div></div>
                        </div>
                        <!-- Step 3 -->
                        <div class="row step" id="step-3" >
                                    ...
                                    <div class="row justify-content-center social-input-list">
                                        <div class="col-lg-6 mb-4">
                                            <div class="social-input">
                                                ...
                                                <input type="text" wire:model="facebook" class="mt-2 text-center w-100" placeholder="@username" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 mb-4">
                                            <div class="social-input">
                                                ...
                                                <input type="text" wire:model="instagram" class="mt-2 text-center w-100" placeholder="@username" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 mb-4">
                                            <div class="social-input">
                                                ...
                                                <input type="text" wire:model="twitter" class="mt-2 text-center w-100" placeholder="@username" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 mb-4">
                                            <div class="social-input">
                                                ...
                                                <input type="text" wire:model="linkedin" class="mt-2 text-center w-100" placeholder="@username" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="social-input">
                                                ...
                                                <input type="text" wire:model="youtube" class="mt-2 text-center w-100" placeholder="@username" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="social-input">
                                                ...
                                                <input type="text" wire:model="tiktok" class="mt-2 text-center w-100" placeholder="@username" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 mt-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-6"><button class="w-100 btn btn-primary btn-smt text-lg" wire:click="moveNext">Continue</button></div>
                                </div>
                            </div>
                        </div>
