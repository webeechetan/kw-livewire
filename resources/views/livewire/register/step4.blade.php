                ...
                <div class="col-xl-7 col-xxl-6 mx-auto text-center">
                    ...
                    @else
                     style="display:none;" @endif>
                        <span class="d-block text-light" id="step-counter">Step 4 of 4</span>
                        ...
                        <div class="step" id="step-4">
                            ...
                            <p class="text-muted mb-4">Enter email addresses to send invites directly.</p>

                            <!-- Copy Link Section -->
                            <div class="input-group mb-4 position-relative d-none">
                                <input type="text" id="inviteLink" class="form-control bg-light text-muted" readonly
                                    value="https://yourapp.com/join/ABC123">
                                <button id="copyBtn" class="btn btn-primary" onclick="copyLink()">COPY</button>
                                <div id="copiedText" class="text-success small position-absolute"
                                    style="right: 10px; top: 100%; display: none;">Copied!</div>
                            </div>

                            <!-- Enter Emails -->
                            <div class="mb-4" wire:ignore>
                                <input type="text" id="emailInput" class="form-control"
                                    placeholder="Enter emails here (comma separated)">
                            </div>

                            <div class="row">
                                <div class="col-md-6"><button class="w-100 btn btn-outline-secondary btn-smt text-lg"
                                        wire:click="finishOnboarding()">Skip for now</button></div>
                                <div class="col-md-6"><button class="w-100 btn btn-primary btn-smt text-lg"
                                        wire:click="finishOnboarding()">Send invitations</button></div>
                            </div>
                        </div>
