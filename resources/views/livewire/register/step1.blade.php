        ...
        <div class="container">
            ...
            <div class="row ">
                <div class="col-xl-7 col-xxl-6 mx-auto text-center">
                    <div id="onboarding">
                        <span class="d-block text-light" id="step-counter">Step 1 of 4</span>
                        ...
                        <div class="row step" id="step-1">
                            <div class="col-12 text-center">
                                ...
                                <div class="options">
                                    <div class="option
                                    @if ($for == 'agency') selected @endif"
                                        onclick="toggleSelection(this)" wire:click="registerOrgFor('agency')">
                                        <span class="checkbox"><i class='bx bx-check text-white'></i></span>
                                        <span class="d-block mb-2"><i
                                                class='bx bx-briefcase-alt-2 bx-md text-primary'></i></span>
                                        <span>I run/manage a</span>
                                        <p class="fw-bold">Creative Agency or Content Team</p>
                                    </div>

                                    <div class="option @if ($for == 'brand') selected @endif"
                                        onclick="toggleSelection(this)" wire:click="registerOrgFor('brand')">
                                        <span class="checkbox"><i class='bx bx-check text-white'></i></span>
                                        <span class="d-block mb-2"><i class='bx bx-edit bx-md text-primary'></i></span>
                                        <span>I manage a</span>
                                        <p class="fw-bold">Brand or In-House Marketing Team</p>
                                    </div>
                                </div>
                                <button class="w-100 btn btn-primary btn-smt text-lg mt-4"
