<div class="container">
    ...
    <div class="col-md-12">
        <div class="column-box h-100">
            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="btn-list">
                        <a href="javascript:" wire:click="$set('status', 'all')" class="btn-border btn-border-sm btn-border-primary "><span><i class='bx bx-objects-horizontal-center' ></i></span> {{ $activity->tasks->count() }} All</a>
                        <a href="javascript:" wire:click="$set('status', 'pending')" class="btn-border btn-border-sm btn-border-primary "><span><i class='bx bx-objects-horizontal-center' ></i></span> {{ $activity->tasks->where('status', 'pending')->count() }} Assigned</a>
                        {{-- <a href="javascript:" wire:click="$set('status', 'pending')" class="btn-border btn-border-sm btn-border-primary "><span><i class='bx bx-objects-horizontal-center' ></i></span> {{ $activity->tasks->where('status', 'pending')->where('due_date', '>', now())->count() }} Assigned</a> --}}
                        <a href="javascript:" wire:click="$set('status', 'in_progress')" class="btn-border btn-border-sm btn-border-secondary "><span><i class='bx bx-objects-horizontal-center' ></i></span> {{ $activity->tasks->where('status', 'in_progress')->count() }} Accepted</a>
                        <a href="javascript:" wire:click="$set('status', 'in_review')" class="btn-border btn-border-sm btn-border-warning "><span><i class='bx bx-objects-horizontal-center' ></i></span> {{ $activity->tasks->where('status', 'in_review')->count() }} In Review</a>
                        <a href="javascript:" wire:click="$set('status', 'overdue')" class="btn-border btn-border-sm btn-border-danger"><span><i class='bx bx-objects-horizontal-center' ></i></span> {{ $activity->tasks->where('due_date', '<', now())->count() }} Overdue</a>
                        <a href="javascript:" wire:click="$set('status', 'completed')" class="btn-border btn-border-sm btn-border-success"><span><i class='bx bx-objects-horizontal-center' ></i></span> {{ $activity->tasks->where('status', 'completed')->count() }} Completed</a>
                    </div>
                </div>
                ...
                @if($tasks->isNotEmpty())
                    ...
                    <div class="taskList_row" wire:key="task-row-{{ $task->id }}">
                        <div class="row">
                            ...
                            <div class="col text-center">
                                <div class="taskList_col"><span>{{ $activity->name }}</span></div>
                            </div>
                            <div class="col text-center">
    ...
    <livewire-components.add-organization-activity :activity="$activity" />
</div>
